...
const airBnbData = [
    {
        ...
        price: 136,
        coverImg: <img src={zaferes} alt="zaferes" className="card--image" />,
        stats: {
            rating: 5.0,
            reviewCount: 6
        },
    ...
    },
    {
        ...
        price: 125,
        coverImg: <img src={weddingPhoto} alt="weddingPhoto" className="card--image" />,
        stats: {
            rating: 5.0,
            reviewCount: 30
        },
